...
namespace HermanBetaAlgorithmAlphaNum
{
    public partial class LibrariesFormVault : Form
    {
        ...
        //private void pictureBoxLoadProj_MouseHover_1(object sender, EventArgs e)
        //{
        //    new ToolTip().SetToolTip(this.pictureBoxLoadProj, "Load Previous Project");
        //}

        //private void pictureBoxVaults_MouseHover(object sender, EventArgs e)
        //{
        //    new ToolTip().SetToolTip(this.pictureBoxVaults, "View vaults");
        //}

        //private void pictureBoxImportVault_MouseHover_1(object sender, EventArgs e)
        //{
        //    new ToolTip().SetToolTip(this.pictureBoxImportVault, "Import vaults");
        //}

        //private void pictureBoxAddConductor_MouseHover(object sender, EventArgs e)
        //{
        //    new ToolTip().SetToolTip(this.pictureBoxAddConductor, "Add a conductor");
        //}
        ...
        //{
        //    new ToolTip().SetToolTip(this.pictureBoxAddGen, "Add a Generator");
        //}
